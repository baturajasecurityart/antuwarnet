    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                print '\n\x1b[1;91mbaturaja@secArt ~> Tidak ada koneksi'
                keluar()

        if 'checkpoint' in url:
            print '\n\x1b[1;91mbaturaja@secArt ~> \x1b[1;93mAccount Checkpointed !'
...
def menu():
    ...
    os.system('clear')
    print logo
    print '\x1b[1;92m\xe2\x95\x94' + 60 * '\xe2\x95\x90'
